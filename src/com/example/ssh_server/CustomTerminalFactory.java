...
public class CustomTerminalFactory implements Factory<Command> {

	private String cmd;
	private String[] args;

	public CustomTerminalFactory(String cmd, String... args) {
		super();
		this.cmd = cmd;
		this.args = args;
	}
	...
	public Command create() {
		return new InvertedShellWrapper(new CustomTerminal());
	}

	private class CustomTerminal implements InvertedShell {
